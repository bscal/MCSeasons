...
public class Config<T>
{
	...
	@ConfigSerializable public static class ServerSettings
	{
		@Setting("TicksPerDay")
		public int TicksPerDay = 24000;
		@Setting("DaysPerMonth") @Comment("Minecraft day is 20 minutes. Default is 7 (2.3 irl hours)")
		...
		public Map<Identifier, SeasonalType> BiomeToSeasonTypeOverrides;
	}
